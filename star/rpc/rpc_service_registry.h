#ifndef STAR_RPC_SERVICE_REGISTRY_H
#define STAR_RPC_SERVICE_REGISTRY_H
#include <memory>
#include <string>
#include <vector>
#include <list>
...
protected:
     ...
     * 处理心跳包
     */
    Protocol::ptr handleHeartbeatPacket(Protocol::ptr p,Address::ptr address);
    /**
     * @brief 处理订阅请求
     */
...
private:
    ...
    // server 的负载
    std::map<std::string,std::atomic<size_t>> m_load;
    // protocol 版本
...
#endif //STAR_RPC_SERVICE_REGISTRY_H
...
#ifndef STAR_IO_MANAGER_H
#define STAR_IO_MANAGER_H
#include <atomic>
#include <memory>
#include "scheduler.h"
#include "sync.h"
...
public:
    ...
    size_t GetPendingEventCount() const { return m_pendingEventCount.load();};
...
#define go (*star::IOManager::GetThis()) +
#define Go  (*star::IOManager::GetThis()) + [=]()mutable
}
#endif //STAR_IO_MANAGER_H
